		...
		},
		{
			...
			want: MetricsBuilderConfig{
				...
				ResourceAttributes: ResourceAttributesConfig{
					...
					VcenterVMCPUCores:          ResourceAttributeConfig{Enabled: true},
					VcenterVMGuestState:        ResourceAttributeConfig{Enabled: true},
					VcenterVMID:                ResourceAttributeConfig{Enabled: true},
					VcenterVMIP:                ResourceAttributeConfig{Enabled: true},
					VcenterVMIsTemplate:        ResourceAttributeConfig{Enabled: true},
					VcenterVMMemoryAllocation:  ResourceAttributeConfig{Enabled: true},
					VcenterVMName:              ResourceAttributeConfig{Enabled: true},
					VcenterVMOs:                ResourceAttributeConfig{Enabled: true},
					VcenterVMPowerState:        ResourceAttributeConfig{Enabled: true},
					VcenterVMStorageAllocation: ResourceAttributeConfig{Enabled: true},
				},
			},
		},
		{
			...
			want: MetricsBuilderConfig{
				...
				ResourceAttributes: ResourceAttributesConfig{
					...
					VcenterVMCPUCores:          ResourceAttributeConfig{Enabled: false},
					VcenterVMGuestState:        ResourceAttributeConfig{Enabled: false},
					VcenterVMID:                ResourceAttributeConfig{Enabled: false},
					VcenterVMIP:                ResourceAttributeConfig{Enabled: false},
					VcenterVMIsTemplate:        ResourceAttributeConfig{Enabled: false},
					VcenterVMMemoryAllocation:  ResourceAttributeConfig{Enabled: false},
					VcenterVMName:              ResourceAttributeConfig{Enabled: false},
					VcenterVMOs:                ResourceAttributeConfig{Enabled: false},
					VcenterVMPowerState:        ResourceAttributeConfig{Enabled: false},
					VcenterVMStorageAllocation: ResourceAttributeConfig{Enabled: false},
				},
			},
		},
	}
