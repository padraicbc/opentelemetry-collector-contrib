...
| vcenter.vm.guest_state | State of VM Guest. | Any Str | true |
| vcenter.vm.id | The instance UUID of the virtual machine. | Any Str | true |
| vcenter.vm.ip | The IP of the VM. | Any Str | true |
| vcenter.vm.is_template | Flag set if VM is a template. | Any Bool | true |
| vcenter.vm.memory.allocation | The memory allocation of the VM. | Any Int | true |
...
| vcenter.vm.storage.allocation | The disk allocation of the VM in bytes. | Any Int | true |
